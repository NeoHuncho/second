...
const suggestedCat = async (text: string) => {
  const [brands, clothingTypes, shoesTypes, shoeModels] = await Promise.all([
    readFile("public/static/keyWords/clothesShoes/brands.txt", "utf8"),
    readFile("public/static/keyWords/clothesShoes/clothingTypes.txt", "utf8"),
    readFile("public/static/keyWords/clothesShoes/shoeTypes.txt", "utf8"),
    readFile("public/static/keyWords/clothesShoes/shoeModels.txt", "utf8"),
  ]);
